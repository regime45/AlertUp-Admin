...
public class geotagging extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomSheetDialog dialog = new BottomSheetDialog(geotagging.this);
        ...
        rgGender.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId == R.id.rbMale){
                    ...
                    DatabaseReference myRef = database.getReference("track").child("user");
        ...
        saveit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(geotagging.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        String onetimekey = getIntent().getStringExtra("SCAN_RESULTS" );
    ...
    private void EnableRuntimePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(geotagging.this,
                Manifest.permission.CAMERA))
        {

            Toast.makeText(geotagging.this,"CAMERA permission allows us to Access CAMERA app", Toast.LENGTH_LONG).show();

        } else {

            ActivityCompat.requestPermissions(geotagging.this,new String[]{
...
//        File storageDir = getExternalFilesDir(Environment.DIRECTORY_PICTURES);
        ...
        if (contentUri != null) {
            ...
            image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(geotagging.this, "Image Is Uploaded.", Toast.LENGTH_SHORT).show();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(geotagging.this, "Upload Failled.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void requestAppPermissions () {
        ...
        Dexter.withActivity(geotagging.this)
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            ...
                            startService(new Intent(geotagging.this, ForegroundService.class));
                        }
